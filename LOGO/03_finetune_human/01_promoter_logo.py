...
def train(train_data_file,
    ...
    k_fold = 0
    shuffle = True
    early_stopping = tf.keras.callbacks.EarlyStopping(monitor='val_auprc_score', patience=3)
    ...
    modelCheckpoint = ModelCheckpoint(filename, monitor='val_auprc_score', save_best_only=True, verbose=1)
